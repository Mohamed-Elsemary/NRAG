...
* The current pipeline processes only pages **47–166** of the source document.
* Page citations indicate the source chunk's page rather than guaranteeing that every generated statement appears verbatim on that page.
* The system is designed for the provided Nokia 1830 PSS technical documentation and is not a general-purpose web search engine.
...
* Automated retrieval metrics such as Recall@K and MRR
* Answer-level evaluation using LLM-as-a-judge
* Streaming Gemini responses
* Web/API interface using FastAPI
* Interactive UI using Streamlit
* Conversation memory
* Multi-document RAG
* Better table extraction from technical PDFs
...
The Nokia technical documentation used as the source document is **not included in this repository**.
